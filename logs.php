...
// Fetch last 100 login attempts
$stmt2 = $pdo->query("SELECT * FROM login_attempts ORDER BY timestamp DESC LIMIT 100");
...
<div class="container mt-5">
    <ul class="nav nav-tabs mb-4" id="logTabs" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="audit-tab" data-bs-toggle="tab" data-bs-target="#audit" type="button" role="tab">System Audit Logs</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="login-tab" data-bs-toggle="tab" data-bs-target="#login" type="button" role="tab">Login Attempts</button>
        </li>
    </ul>
